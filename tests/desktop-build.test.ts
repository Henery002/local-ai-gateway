...
describe("desktop build output", () => {
  ...
  it("uses Figma stat-card hooks for usage and overview metrics", () => {
    ...
    expect(overview).toContain("id=\"overview-total-quota\"");
    expect(overview).toContain("id=\"overview-total-quota-detail\"");
    expect(overview?.match(/class="card overview-status-card stat-card"/g) ?? []).toHaveLength(5);
    ...
    expect(rendererSource).toContain("renderUsagePeriodSummary");
    expect(rendererSource).toContain("summarizeAccountQuotaAggregate");
    expect(rendererSource).toContain("summarizePoolQuotaAggregate");
    expect(rendererSource).toContain("renderQuotaAggregateBadge");
    ...
    expect(styles).toContain(".usage-period-summary {");
    expect(styles).toContain(".usage-period-card {");
    expect(styles).toContain(".quota-aggregate-value");
  ...
  it("renders member-first request audit controls and stronger operations cards", () => {
    ...
    expect(indexHtml).toContain('id="account-usage-ranking-list"');
  ...
  it("uses Figma hooks for the usage and alerts workbench", () => {
    ...
    expect(usageView).toContain("id=\"usage-observe-window\"");
    expect(usageView).toContain("id=\"usage-period-summary\"");
    expect(usageView).toContain("data-usage-window=\"weekly\"");
    expect(usageView).toContain("data-usage-window=\"monthly\"");
    expect(usageView).toContain("data-usage-window=\"history\"");
    ...
    expect(rendererSource).toContain("renderUsageTrendMetricStats");
    expect(rendererSource).toContain("buildUsageTrendMetricStats");
    expect(rendererSource).toContain("usage-trend-stat-grid");
    ...
    expect(styles).toContain(".usage-trend-stat-grid");
